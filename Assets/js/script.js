    ...
    $(function() {
        ...
        calendar = new Calendar(document.getElementById('calendar'), {
            ...
            eventClick: function(info) {
                ...
                if (!!scheds[id]) {
                    ...
                    _details.find('#notas').text(scheds[id].notas)
                    _details.find('#monto').text(scheds[id].monto)
                    _details.find('#pagos').text(scheds[id].pagos)
        ...
        $('#edit').click(function() {
            ...
            if (!!scheds[id]) {
                ...
                _form.find('[name="notas"]').val(scheds[id].notas)
                _form.find('[name="monto"]').val(scheds[id].monto)
                _form.find('[name="pagos"]').val(scheds[id].pagos)
